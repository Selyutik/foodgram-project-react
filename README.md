...
```
git clone https://github.com/selyutik/foodgram-project-react.git
cd backend
```
...
http://84.201.138.112/api/docs/redoc.html
### Развёрнутый проект:
http://84.201.138.112 
http://84.201.138.112/admin/

## Об авторе
[selyutik](https://github.com/selyutik/)